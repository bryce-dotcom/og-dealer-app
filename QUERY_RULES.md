...
**Confirmed existing tables** (actively queried by frontend): `dealer_settings`, `inventory`, `employees`, `bhph_loans`, `deals`, `customers`, `bhph_payments`, `commissions`, `commission_roles`, `inventory_expenses`, `inventory_commissions`, `customer_vehicle_requests`, `time_clock`, `time_off_requests`, `employee_documents`, `payroll_runs`, `paystubs`, `bank_accounts`, `bank_transactions`, `manual_expenses`, `expense_categories`, `assets`, `liabilities`, `saved_reports`, `generated_documents`, `feedback`, `audit_log`, `promo_codes`, `message_templates`, `compliance_rules`, `state_updates`, `document_packages`, `form_staging`, `form_library`, `form_registry`, `investors`, `investment_pools`, `investor_pool_shares`, `investor_capital`, `investor_vehicles`, `investor_distributions`, `investor_reports`, `investor_notifications`, `investor_documents`, `pool_transactions`, `sms_messages`, `sms_settings`, `customer_interactions`, `appointments`, `dealer_notifications`, `esignature_requests`, `analytics_snapshots`, `compliance_tracking`, `compliance_checklist_items`, `marketplace_listings`, `crm_workflows`, `crm_workflow_runs`, `customer_portal_access`, `customer_portal_payments`, `leads`, `reconditioning_tasks`, `reconditioning_templates`, `vehicle_gps_tracking`, `gps_location_history`, `trade_ins`, `deal_timeline`, `floor_plan_lenders`, `floor_plan_vehicles`, `fi_products`, `fi_deal_products`, `auction_accounts`, `auction_transactions`, `wholesale_buyers`, `vehicle_photos`, `title_tracking`, `vendors`, `vendor_payments`, `test_drives`, `key_tracking`, `lot_positions`, `warranty_claims`, `dealer_tasks`, `service_orders`, `service_line_items`, `lenders`, `lender_submissions`, `deal_jackets`, `deal_jacket_documents`, `vehicle_inspections`, `customer_reviews`
