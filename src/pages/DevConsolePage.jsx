...
export default function DevConsolePage() {
  const { dealerId, dealer, inventory, employees, bhphLoans, deals, customers, setDealer } = useStore();
  ...
  const loadAllData = async () => {
    setLoading(true);
    try {
      const [dealers, users, feedback, audit, promos, templates] = await Promise.all([
  ...
  const tables = ['inventory', 'deals', 'bhph_loans', 'customers', 'employees', 'dealer_settings', 'feedback', 'audit_log', 'promo_codes', 'message_templates'];
